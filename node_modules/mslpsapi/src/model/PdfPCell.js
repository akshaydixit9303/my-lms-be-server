...
(function(root, factory) {
  ...
  /**
   * The PdfPCell model module.
   * @module model/PdfPCell
   * @version v1
   */

  /**
   * Constructs a new <code>PdfPCell</code>.
   * @alias module:model/PdfPCell
   * @class
   */
  ...
  /**
   * Constructs a <code>PdfPCell</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PdfPCell} obj Optional instance to populate.
   * @return {module:model/PdfPCell} The populated <code>PdfPCell</code> instance.
   */
