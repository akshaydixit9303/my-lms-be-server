...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Mslpsapi.Annotation = factory(root.Mslpsapi.ApiClient, root.Mslpsapi.Chunk);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('AnnotationType')) {
        obj['AnnotationType'] = ApiClient.convertToType(data['AnnotationType'], 'Integer');
      }
