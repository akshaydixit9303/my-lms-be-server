...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mslpsapi.ByteBuffer();
  });
  ...
  describe('ByteBuffer', function() {
    it('should create an instance of ByteBuffer', function() {
      // uncomment below and update the code to test ByteBuffer
      //var instane = new Mslpsapi.ByteBuffer();
      //expect(instance).to.be.a(Mslpsapi.ByteBuffer);
    });
