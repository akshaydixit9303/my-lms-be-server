...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mslpsapi.PdfContentByte();
  });
  ...
  describe('PdfContentByte', function() {
    it('should create an instance of PdfContentByte', function() {
      // uncomment below and update the code to test PdfContentByte
      //var instane = new Mslpsapi.PdfContentByte();
      //expect(instance).to.be.a(Mslpsapi.PdfContentByte);
    });
