...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mslpsapi.BaseColor();
  });
  ...
  describe('BaseColor', function() {
    it('should create an instance of BaseColor', function() {
      // uncomment below and update the code to test BaseColor
      //var instane = new Mslpsapi.BaseColor();
      //expect(instance).to.be.a(Mslpsapi.BaseColor);
    });
