...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mslpsapi.OutputStreamCounter();
  });
  ...
  describe('OutputStreamCounter', function() {
    it('should create an instance of OutputStreamCounter', function() {
      // uncomment below and update the code to test OutputStreamCounter
      //var instane = new Mslpsapi.OutputStreamCounter();
      //expect(instance).to.be.a(Mslpsapi.OutputStreamCounter);
    });
