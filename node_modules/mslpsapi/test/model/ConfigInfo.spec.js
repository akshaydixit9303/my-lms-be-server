...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mslpsapi.ConfigInfo();
  });
  ...
  describe('ConfigInfo', function() {
    it('should create an instance of ConfigInfo', function() {
      ...
      //var instane = new Mslpsapi.ConfigInfo();
      //expect(instance).to.be.a(Mslpsapi.ConfigInfo);
    });
    ...
    it('should have the property configValue (base name: "ConfigValue")', function() {
      // uncomment below and update the code to test the property configValue
      //var instane = new Mslpsapi.ConfigInfo();
      //expect(instance).to.be();
    });
