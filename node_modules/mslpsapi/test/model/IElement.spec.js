...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mslpsapi.IElement();
  });
  ...
  describe('IElement', function() {
    it('should create an instance of IElement', function() {
      // uncomment below and update the code to test IElement
      //var instane = new Mslpsapi.IElement();
      //expect(instance).to.be.a(Mslpsapi.IElement);
    });
