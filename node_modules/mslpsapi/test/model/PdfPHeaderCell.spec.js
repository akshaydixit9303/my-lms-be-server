...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Mslpsapi.PdfPHeaderCell();
  });
  ...
  describe('PdfPHeaderCell', function() {
    it('should create an instance of PdfPHeaderCell', function() {
      // uncomment below and update the code to test PdfPHeaderCell
      //var instane = new Mslpsapi.PdfPHeaderCell();
      //expect(instance).to.be.a(Mslpsapi.PdfPHeaderCell);
    });
