...
function execCmd(cmd, opts) {
    return __awaiter(this, void 0, void 0, function () {
        var directory, output, outputErr, stdout, child, stderr;
        return __generator(this, function (_a) {
            directory = opts && opts.cwd;
...
function execCmdResult(cmd, opts) {
    return __awaiter(this, void 0, void 0, function () {
        var directory, output, outputErr, stdout, stderr, child;
        return __generator(this, function (_a) {
            directory = opts && opts.cwd;
            printCommand(cmd, directory);
            output = [];
...
function printCommand(cmd, directory) {
    console.log(chalk.grey("running $ " + cmd, directory ? "\n(in dir: [" + directory + "])" : undefined));
}
